...
export class SummaryBuilder {
    ...
    async buildSummary() {
        ...
        const promises = this.summary.sections.map((section: Section) => 
            this.buildParagraphs(section.rawTextofSection).then(generatedParagraphs => {
    ...
    async buildParagraphs(text: string) {
        console.log("buildParagraphs", text);
